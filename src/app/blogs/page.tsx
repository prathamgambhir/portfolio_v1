...
import { MotionDiv, MotionP, MotionSpan } from "@/components/motion-div";
...
export default function BlogsPage() {
  return (
    ...
    >
      ...
      >
        <span className="text-[11px] uppercase tracking-widest text-neutral-400 font-bold group-hover:scale-105 dark:group-hover:text-neutral-200 group-hover:text-neutral-600 transition-all duration-300">
